...
function App() {
  ...
  useEffect(() => {
    const applyStageHeight = () => {
      ...
      // Mobile only: shrink slide content on smaller screens so nothing overflows.
      // Reference "full" screen is 800px tall / 390px wide (scale = 1); smaller
      ...
      // starting at 900px tall, capped at 1.5x. Backgrounds are not affected.
      const largeReferenceHeight = 900
      const maxScale = 1.5
